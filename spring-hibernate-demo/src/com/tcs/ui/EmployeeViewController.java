	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("Enter id and salary");
				...
				try {
				Employee emp = employeeService.updateEmployeeSalary(scan.nextInt(),scan.nextDouble());
				System.out.println(emp.getName()+"your id is :"+emp.getId()+ "your salary is :"+ emp.getSalary());
				} catch (EmployeeNotFoundException e1) {
